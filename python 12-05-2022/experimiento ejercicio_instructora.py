...
#max_key = max(meses_produccion_2021, key=lambda key: meses_produccion_2021[key])
min_key=  min(meses_produccion_2021, key=meses_produccion_2021.get)
#max_key = max(meses_produccion_2021, key = meses_produccion_2021.get)
...
#print('esta es el el mes con yor produccion',Keymax,'y su valor es:',meses_produccion_2021(Keymax),'este es el mes con la menor producion',min_key,'y este es el promedio',promedio)